 ...
 * 
 */
public class RelaxedSSLSocketFactory implements SocketFactory,
		LayeredSocketFactory {
	private String certKey = null;
	private SSLContext sslcontext = null;

	public RelaxedSSLSocketFactory(String certKey) {
	...
	private static SSLContext createEasySSLContext(String certKey)
		...
		try {
			...
			context.init(null, new TrustManager[] { new RelaxedSSLTrustManager(certKey) }, null);
