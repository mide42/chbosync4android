...
public class DialogController extends BasicDialogController {
    ...
    protected class WIFINotAvailableDialogOption extends DialogOption {
        ...
        private List<AppSyncSource> filteredSources;
    ...
    class FirstSyncDialogState {
        ...
        protected List<AppSyncSource> filteredSources;
        protected int delay;
        ...
        protected void update(AppSyncSource[] appSourceList, String syncType,
        					  List<AppSyncSource> filteredSources, boolean refresh,
    ...
    public void showFirstSyncDialog(Screen screen, AppSyncSource[] appSourceList, String syncType,
    								List<AppSyncSource> filteredSources, boolean refresh, int direction,
    ...
    protected class FirstSyncDialogOption extends DialogOption {
        ...
        public void run() {
            ...
            if (getValue() == 0) {
                ...
                filteredSources.add(appSourceList[sourceIndex]);
            }
            hsCont.redraw();
